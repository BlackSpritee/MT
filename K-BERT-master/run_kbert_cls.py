...
def main():
    ...
    parser.add_argument("--train_path", default='./datasets/shopping/train.tsv', type=str,
                        help="Path of the trainset.")
    parser.add_argument("--dev_path", default='./datasets/shopping/dev.tsv', type=str,
                        help="Path of the devset.")
    parser.add_argument("--test_path", default='./datasets/shopping/test.tsv', type=str,
    ...
    # kg
    parser.add_argument("--kg_name", default="./datasets/CnDbpedia.spo", help="KG name or path")
    ...
    # labels_set = {'hasA':0, 'synonym':1, 'uncorrelated':2, 'needA':3, 'correlated':4, 'needSpecific':5, 'hypernym':6}
    labels_set = set()
    columns = {}
