...
label2id = {'hasA': 0, 'synonym': 1, 'uncorrelated': 2, 'needA': 3, 'correlated': 4, 'needSpecific': 5,
            'hypernym': 6}
...
def add_knowledge_worker(params):
    ...
    for line_id, line in enumerate(sentences):
        ...
        label = int(label2id[line[columns["label"]]])
        text = CLS_TOKEN + ENT1S_TOKEN + line[columns["sub"]] + ENT1E_TOKEN + ENT2S_TOKEN + line[
            columns["obj"]] + ENT2E_TOKEN + line[columns["text_a"]]
...
def main():
    ...
    # Path options.
    parser.add_argument("--pretrained_model_path", default="../bert-base-chinese/pytorch_model.bin", type=str,
                        help="Path of the pretrained model.")
    parser.add_argument("--output_model_path", default="./models/classifier_model.bin", type=str,
                        help="Path of the output model.")
    parser.add_argument("--vocab_path", default="./models/google_vocab.txt", type=str,
                        help="Path of the vocabulary file.")
    parser.add_argument("--train_path", default='./datasets/mt/train.tsv',type=str,
                        help="Path of the trainset.")
    parser.add_argument("--dev_path",  default='./datasets/mt/dev.tsv',type=str,
                        help="Path of the devset.")
    parser.add_argument("--test_path", default='./datasets/mt/test.tsv',type=str,
    ...
    # kg
    parser.add_argument("--kg_name", default="./datasets/mt/cross2.spo", help="KG name or path")
        ...
        for line_id, line in enumerate(f):
            try:
                ...
                if line_id == 0:
                    ...
                    break
            # continue
            #     label = int(labels_set[line[columns["label"]]])
